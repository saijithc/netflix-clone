...
class Details extends StatelessWidget {
    Details({Key? key, required this.name, required this.description, required this.bannerurl, required this.posterurl, required this.vote,required this.relese  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    body: ListView(children: [SizedBox(height: 250,child: Stack(children: [Positioned(
      ...
      child: Text('Releasing on -'+relese,style: const TextStyle(color: Colors.white,fontSize: 15),),),
      Padding(
